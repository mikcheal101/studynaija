		<div class="col-sm-10 p-r-00 p-l-05" ng-init="loadNews ();">
							...
							<ul class="list-group">
								<li class="list-group-item" dir-paginate="n in news | filter:newsSearch | itemsPerPage : 50" >
									<div class="pull-right">
										<p class="font-11 text-ash-01" ng-bind="n.date | myDate | date : 'd , yyyy. h:mm a'"></p>
										<p class="text-red fa fa-times pull-right m-t-10" ng-click="dropNews ($index);"></p>
									</div>
									
									<h4 ng-click="editNews ($index);">
										<p class="text-600 font-13 p-b-10 text-info text-uppercase" ng-bind="n.subject"></p>
